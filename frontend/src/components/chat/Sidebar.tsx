  ...
  return (
    <div className="flex h-screen w-72 flex-col border-r border-slate-800 bg-slate-900">
      ...
      <div className="p-4">
        <button
          onClick={onNewChat}
          className="flex w-full items-center justify-center gap-2 rounded-xl bg-violet-600 px-4 py-3 font-semibold transition hover:bg-violet-700"
        >
      ...
      <div className="flex-1 space-y-2 overflow-y-auto px-4">
        <button className="flex w-full items-center gap-3 rounded-xl p-3 text-left hover:bg-slate-800">
